...
const TESTIMONIALS = [
  ...
  { quote: "Traditional mock interviews felt fake. PrepSpace's Gemini Live interview felt like a real phone screen — I could even interrupt the AI when I remembered something. That confidence carried into my actual interviews.", name: 'Marcus T.', role: 'ML Engineer · Anthropic', improvement: '3 offers in 3 weeks', tag: 'badge-mint' },
