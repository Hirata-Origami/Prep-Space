...
export default function ResumeBuilderPage() {
  ...
  const handleGenerate = () => {
    ...
    setGenerating(true);
    toast.info('Gemini 2.5 Flash is crafting your resume…');
    setTimeout(() => { setGenerating(false); toast.success('Resume generated! Switching to preview.'); setTab('preview'); }, 3000);
  };
